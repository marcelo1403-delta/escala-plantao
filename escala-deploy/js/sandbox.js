...
const executarGravarPagina=async()=>{
  ...
  if(status==="fechado"&&window._modoEdicaoForcado){
    ...
    popMsg("Arquivo gravado com sucesso");
    atualizarModoLeituraEscala();
    return;
  }
